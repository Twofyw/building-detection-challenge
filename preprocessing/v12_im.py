...
BASE_DIR = "/home/twofyw/data/building/train"
BASE_TEST_DIR = "/home/twofyw/data/building/test"
WORKING_DIR = "/home/twofyw/data/building/working"
IMAGE_DIR = "/home/twofyw/data/building/working/images/{}".format('v12')
V5_IMAGE_DIR = "/home/twofyw/data/building/working/images/{}".format('v5')

MODEL_DIR = "/home/twofyw/data/building/working/models/{}".format(MODEL_NAME)
FN_SOLUTION_CSV = "/home/twofyw/data/building/output/{}.csv".format(MODEL_NAME)
...
def directory_name_to_area_id(datapath):
    ...
    Usage:
        ...
        >>> directory_name_to_area_id("/home/twofyw/data/building/test/AOI_2_Vegas")
        2
    """
